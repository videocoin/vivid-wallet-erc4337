...
export class Client implements IClient {
  ...
  private constructor(rpcUrl: string, bundlerUrl: string, entryPoint: string) {

    console.log("***** Client initialize ********",rpcUrl, bundlerUrl) ;
    this.provider = new ethers.providers.JsonRpcProvider(rpcUrl);
    this.bundler = new ethers.providers.JsonRpcProvider(bundlerUrl);
  ...
  public static async init(rpcUrl: string, bundlerUrl: string,entryPoint: string) {
    const instance = new Client(rpcUrl, bundlerUrl, entryPoint);
